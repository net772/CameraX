...
import com.example.camerax.ImageListActivity.Companion.IMAGE_LIST_REQUEST_CODE
import com.example.camerax.databinding.ActivityMainBinding
import com.example.camerax.extensions.clear
...
class MainActivity : AppCompatActivity() {
    ...
    private fun startCamera(viewFinder: PreviewView) {
        cameraExecutor = Executors.newSingleThreadExecutor() // ExecutorService 인스턴스를 얻고
    ...
    private fun bindCameraUseCase() = with(binding) {
        ...
        cameraProviderFuture.addListener({
            ...
            try {
                ...
                ) //  Camera 객체를 반환 - 확대/축소, 노출과 같은 카메라 출력을 제어
